                ...
                >
                    <SwiperSlide>
                        <div className="relative">
                            <div
                                className="absolute inset-0 rounded-b-xl mb-5"style={{background: `url(${bg1})`,height: '800px', backgroundSize: 'cover',backgroundPosition: 'center',filter: 'brightness(60%)',zIndex: 0,}}
                            ></div>
                    ...
                    <SwiperSlide>
                           <div className="relative">
                                    <div
                                        className="absolute inset-0 rounded-b-xl mb-5"style={{background: `url(${bg3})`,height: '800px', backgroundSize: 'cover',backgroundPosition: 'center',filter: 'brightness(60%)',zIndex: 0,}}
                                    ></div>
                                    <div className="relative z-10 flex flex-col-reverse md:flex-row py-20 items-center px-8">
                                        <div className="text-white md:px-10">
                                            <h1 className="md:text-3xl text-xl font-bold pt-5">
                    ...
                    <SwiperSlide>
                            <div className="relative">
                                        <div
                                            className="absolute inset-0 rounded-b-xl mb-5"style={{background: `url(${bg2})`,height: '800px', backgroundSize: 'cover',backgroundPosition: 'center',filter: 'brightness(60%)',zIndex: 0,}}
                                        ></div>
                                        <div className="relative z-10 flex flex-col-reverse md:flex-row py-20 items-center px-8">
                                            <div className="text-white md:px-10">
                                                <h1 className="md:text-3xl text-xl font-bold pt-5">
